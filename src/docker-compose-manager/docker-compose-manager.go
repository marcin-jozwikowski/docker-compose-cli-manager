...
func (d *DockerComposeManager) DockerComposeDown(projectName string, additionalArguments []string) error {
	return d.runCommand("down", []string{"-p", projectName}, DockerComposeProject{}, additionalArguments)
}
